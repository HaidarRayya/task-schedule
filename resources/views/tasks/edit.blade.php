...
<div class="container text-white">
    <form class method="POST" action="{{ route('tasks.update',['task'=>$task->id]) }}">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="description"
                placeholder="قم بادخال الوصف">{{ $task->description  }}</textarea>
            @error('description')
            <p class="error_message">{{ $message }}</p>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="date" name="due_date" value="{{ $task->due_date }}">
